...
# FLUX-dev VAE normalisation constants
VAE_SCALE = 0.3611
VAE_SHIFT = 0.1159
...
def build_cache(images_dir, captions_dir, cache_dir, model_id, device):
    ...
    if latents_path.exists() and embeddings_path.exists():
        log.info("Cache exists, skipping encoding")
        return
    ...
    log.info("Encoding images with VAE...")
    ...
    log.info("Encoding captions with CLIP...")
    ...
    log.info("Encoding captions with T5...")
